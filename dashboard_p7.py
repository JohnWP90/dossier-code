...
applicant_id = st.sidebar.selectbox(label="Select or write applicant's ID :", options=data.SK_ID_CURR, index=0)
...
if applicant_id:
    ...
    if graphs == "Model performance":
        ...
        #Seventh histogram
        if compare_with_others=="Number of family members":
            plot_histogram("CNT_FAM_MEMBERS", "Number of family members")

        #Eighth histogram
        if compare_with_others=="Education":
            plot_histogram("NAME_EDUCATION_TYPE", "Education")